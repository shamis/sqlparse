...
test_compacted(_Config) ->
    ...
    {ok, _} = sqlparse:parsetree_with_tokens("Select - 10                     / -5                       From dual"),
    {ok, _} = sqlparse:parsetree_with_tokens("Select - 10                     + -5                       From dual"),
    {ok, _} = sqlparse:parsetree_with_tokens("Select - 10                     * col_2                    From dual"),
    {ok, _} = sqlparse:parsetree_with_tokens("Select - 10                     / col_2                    From dual"),
    {ok, _} = sqlparse:parsetree_with_tokens("Select - 10                     + col_2                    From dual"),
    {ok, _} = sqlparse:parsetree_with_tokens("Select - 10                     * 10 + 5                   From dual"),
    {ok, _} = sqlparse:parsetree_with_tokens("Select - 10                     / 10 + 5                   From dual"),
    {ok, _} = sqlparse:parsetree_with_tokens("Select - 10                     + 10 + 5                   From dual"),
    {ok, _} = sqlparse:parsetree_with_tokens("Select - 10                     * (Select col_2 From dual) From dual"),
    {ok, _} = sqlparse:parsetree_with_tokens("Select - 10                     / (Select col_2 From dual) From dual"),
    {ok, _} = sqlparse:parsetree_with_tokens("Select - 10                     + (Select col_2 From dual) From dual"),
    {ok, _} = sqlparse:parsetree_with_tokens("Select col_1                    * -5                       From dual"),
    {ok, _} = sqlparse:parsetree_with_tokens("Select col_1                    / -5                       From dual"),
    {ok, _} = sqlparse:parsetree_with_tokens("Select col_1                    + -5                       From dual"),
    {ok, _} = sqlparse:parsetree_with_tokens("Select 5 + 10                   * -5                       From dual"),
    {ok, _} = sqlparse:parsetree_with_tokens("Select 5 + 10                   / -5                       From dual"),
    {ok, _} = sqlparse:parsetree_with_tokens("Select 5 + 10                   + -5                       From dual"),
    {ok, _} = sqlparse:parsetree_with_tokens("Select (Select col_1 From dual) * -5                       From dual"),
    {ok, _} = sqlparse:parsetree_with_tokens("Select (Select col_1 From dual) / -5                       From dual"),
    {ok, _} = sqlparse:parsetree_with_tokens("Select (Select col_1 From dual) + -5                       From dual"),
    {ok, _} = sqlparse:parsetree_with_tokens("Select col_1                    * col_2                    From dual"),
    {ok, _} = sqlparse:parsetree_with_tokens("Select col_1                    / col_2                    From dual"),
    {ok, _} = sqlparse:parsetree_with_tokens("Select col_1                    + col_2                    From dual"),
    {ok, _} = sqlparse:parsetree_with_tokens("Select 5 + 10                   * 10 + 5                   From dual"),
    {ok, _} = sqlparse:parsetree_with_tokens("Select 5 + 10                   / 10 + 5                   From dual"),
    {ok, _} = sqlparse:parsetree_with_tokens("Select 5 + 10                   + 10 + 5                   From dual"),
    {ok, _} = sqlparse:parsetree_with_tokens("Select (Select col_1 From dual) * (Select col_2 From dual) From dual"),
    {ok, _} = sqlparse:parsetree_with_tokens("Select (Select col_1 From dual) / (Select col_2 From dual) From dual"),
    {ok, _} = sqlparse:parsetree_with_tokens("Select (Select col_1 From dual) + (Select col_2 From dual) From dual"),
    ...
    {ok, _} = sqlparse:parsetree_with_tokens("select * from dual where column_1 in (1,2,3)"),
    {ok, _} = sqlparse:parsetree_with_tokens("select * from dual where column_1 like 1"),
    {ok, _} = sqlparse:parsetree_with_tokens("select * from dual where column_1 like (1)"),
    ok.
