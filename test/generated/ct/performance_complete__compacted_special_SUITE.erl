...
test_compacted(_Config) ->
    ...
    {ok, _} =
        sqlparse:parsetree_with_tokens("Create Index a On b (c, d|:d{}|)"),
    ...
    {ok, _} =
        sqlparse:parsetree_with_tokens("Select table_name.column_name From x"),
    {ok, _} = sqlparse:parsetree_with_tokens(
    ...
    {ok, _} =
        sqlparse:parsetree_with_tokens("Call Upper (All name1.name2.name3)"),
    {ok, _} = sqlparse:parsetree_with_tokens(
    ...
    {ok, _} =
        sqlparse:parsetree_with_tokens("Insert Into table_name Values (1)"),
    {ok, _} = sqlparse:parsetree_with_tokens(
    ...
    {ok, _} =
        sqlparse:parsetree_with_tokens("Select (Select * From dual) From dual"),
    ok.
